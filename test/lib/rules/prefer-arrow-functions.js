...
tester.run("lib/rules/prefer-arrow-functions", rule, {
  ...
  valid: [
    ...
    {
      code: 'module.exports = function() { return "bar"; }',
      options: [{ allowStandaloneDeclarations: true }],
    },
    {
      code: 'module.exports.foo = function() { return "bar"; }',
      options: [{ allowStandaloneDeclarations: true }],
    },
    {
  ...
  invalid: [
    {
      ...
      errors: ["Use const or class constructors instead of named functions"],
    },
    {
    ...
    {
      code: "function foo() { return function () { return this; }; }",
      errors: ["Use const or class constructors instead of named functions"],
    },
    {
      code: "function foo() { return function (bar = this) { return bar; }; }",
      errors: ["Use const or class constructors instead of named functions"],
    },
    {
      code: "const foo = function () { return function (bar = this) { return bar; }; }",
      errors: ["Prefer using arrow functions over plain functions"],
    },
    {
      code: "const foo = function () { return function () { return this; }; }",
      errors: ["Prefer using arrow functions over plain functions"],
    },
    {
    ...
    },
    {
      ...
      errors: ["Prefer using arrow functions over plain functions"],
      options: [
        { allowStandaloneDeclarations: true, classPropertiesAllowed: true },
      ],
    },
    {
    ...
    ...[
      ...
      [
        'const foo = { barProp() { return "bar"; } };',
        'const foo = { barProp: () => "bar" };',
      ],
      ...
      [
        "var foo = function() { return {a: false} }",
        "var foo = () => ({a: false})",
      ],
      [
        "var foo = function() { return {a: false}; }",
      ...
      [
        "var foo = function () { return function(a) { a() } }",
      ...
      ...[
        ...
        [
          'var foo = async function() { return "bar" };',
          'var foo = async () => "bar";',
        ],
        [
